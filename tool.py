...
#def calculate_position_box(actions, xmin=65, xmax=159, ymin=65, ymax=159):
...
def show_new_bdbox(image, box, color='r', count=0):
    """
        查看标注框对应的图片
    """
